...
void init_referee_struct_data(void)
{
    ...
    memset(&robot_hurt_t, 9, sizeof(ext_robot_hurt_t));//考虑到冲突问题，set为9
...
{
    *heat1_limit = robot_state.shooter_id1_42mm_cooling_limit;
...
/**
  ...
  * @retval         
  */
const ext_game_robot_state_t *get_robot_state_point(void)
{
    return &robot_state;
}
